...
manager.onLoad=()=>setLoadProgress(1);
...
const PRE_SHOT_DELAY=1.0;      // hedef secildikten sonra bekleme (s)
const KICK_CONTACT_DELAY=0.26; // kick animasyonunda topa temas (s)
let shotTarget=null;
